package com.lazydsr.platform.config.cache.redis;
...
public class RedisService<T> {
     ...
     * @param value value
     */
    public void setList(String key, T value, long expireTime) {
     ...
     * @param list list
     */
    public void setListAll(String key, List<T> list, long expireTime) {
